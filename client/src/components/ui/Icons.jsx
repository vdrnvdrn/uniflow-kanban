// Minimal SVG Icon Components - Lucide-style line icons
...
// App Logo - Kanban Board Icon
export const IconKanban = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const IconDumbbell = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M4.5 8.5l-1-1" />
    <path d="M19.5 15.5l1 1" />
    <path d="M8.5 4.5l-1-1" />
    <path d="M15.5 19.5l1 1" />
  </svg>
);
...
export const IconFolder = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
